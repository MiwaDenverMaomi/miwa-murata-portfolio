...
const initialState: StateType = {
    ...
    works: {
        webDev: [
            ...
            { id: 'web_9', alt: "Website:Miwa's Portfolio", name: "Miwa's portfolio", language_tools: 'React,Redux', desc: 'My portfoio website with a contact form.It showcases my apps and illustrations.', category: 'webDev', url: 'https://murata-miwa-portfolio.netlify.app/', source: 'https://github.com/MiwaDenverMaomi/miwa-murata-portfolio' },
        ],
        illust: [

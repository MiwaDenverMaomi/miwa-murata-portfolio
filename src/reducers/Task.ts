...
const initialState: StateType = {
    ...
    works: {
        webDev: [
            { id: 'web_1', alt: 'Application1:My Todo Lists', name: 'My Todo Lists', language_tools: 'php(Laravel),Typescript,Bootstrap', desc: "Share your todo lists.Features:sign up/login/logout/password reset/contact form/cancel membership/profile/like/favorite folder,etc. other than todo list features.", category: 'webDev', url: 'https://www.share-my-todo-list.com/', source: 'https://github.com/MiwaDenverMaomi/my_todo_lists/tree/master' },
            ...
            { id: 'web_5', alt: 'Website:Baby Word Dictionary', name: 'Baby Words Dictionary', language_tools: 'JavaScript', desc: 'You can make a list of the words your baby says.', category: 'webDev', url: 'https://miwadenvermaomi.github.io/baby_word_list/', source: 'https://github.com/MiwaDenverMaomi/baby_words_dictionary' },
